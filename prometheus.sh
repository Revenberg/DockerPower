...
#        ansible-playbook  /home/pirate/powercontainers/changepassword.yml --connection=local --extra-vars "passwordfile=/home/pirate/.pswrd" | tee /home/pi/prometheus.log
...
#    fi
    ...
    ansible-playbook  /home/pi/powercontainers/changepassword.yml --connection=local --extra-vars "passwordfile=/home/pirate/.pswrd" | tee /home/pi/prometheus.log
...
cp /home/pi/powercontainers/prometheus.sh /home/pi/prometheus.sh;
chmod +x /home/pi/prometheus.sh;
...
ansible-playbook  /home/pi/powercontainers/prometheus.yml --vault-password-file /home/pi/.pswrd -i /home/pi/ansible/hosts | tee /home/pi/prometheus.log
